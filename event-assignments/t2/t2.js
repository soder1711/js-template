...
for (let restaurant of sortedRestaurants) {
  ...
  name.addEventListener("click", function () {
    ...
    dialog.innerHTML = `<h2>${restaurant.name}</h2><p>Address: ${restaurant.address}</p><p>Postal code: ${restaurant.postalCode}</p><p>City: ${restaurant.city}</p><p>Phone: ${restaurant.phone}</p><p>Company: ${restaurant.company}</p><button id="close">Close</button>`;
    dialog.showModal();
